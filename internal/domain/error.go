...
const (
	...
	ErrCodeCacheError            = 10021 // 缓存操作异常
	ErrCodeCacheConnectFailed    = 10022 // 缓存连接失败
	ErrCodeCacheSerializeError   = 10023 // 缓存序列化错误
	ErrCodeCacheDeserializeError = 10024 // 缓存反序列化错误
	ErrCodeMQPublishError        = 10025 // MQ消息发布错误
	ErrCodeCartEmpty             = 10026 // 购物车为空
)
